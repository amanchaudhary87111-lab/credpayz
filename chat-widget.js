...
(function () {
  ...
  .cpz-panel{position:fixed;left:22px;bottom:22px;z-index:9999;width:370px;max-width:calc(100vw - 28px);height:560px;max-height:calc(100vh - 40px);
  ...
  .cpz-body{flex:1;overflow-y:auto;padding:18px;background:#f7f5ff;display:flex;flex-direction:column;gap:12px}
  .cpz-msg{max-width:82%;padding:11px 14px;border-radius:14px;font-size:13.5px;line-height:1.55;white-space:pre-wrap;word-wrap:break-word}
  ...
  .cpz-cta{display:flex;gap:8px;padding:8px 18px 0}
  .cpz-cta a{flex:1;text-align:center;text-decoration:none;font-size:12.5px;font-weight:700;padding:9px;border-radius:10px;color:#fff;display:flex;align-items:center;justify-content:center;gap:6px}
  ...
  .cpz-foot{padding:12px 14px;background:#fff;border-top:1px solid rgba(124,58,237,.1);display:flex;gap:8px;align-items:flex-end}
  .cpz-input{flex:1;border:1px solid rgba(124,58,237,.2);border-radius:22px;padding:11px 15px;font-size:13.5px;font-family:inherit;
  ...
  @media(max-width:480px){
    .cpz-panel{left:0;bottom:0;width:100vw;max-width:100vw;height:100dvh;max-height:100dvh;border-radius:0}
  ...
  function offlineReply(text) {
    ...
    if (/(rate|price|charge|percent|%|fee|cost|bill)/.test(t))
      return "Our charges depend on the amount and type (one-time or monthly rotation). For bill payment it starts at just 0.8%. For the best rate for your case, tap WhatsApp or Call below on 9911312139 / 9711191198. 🙏";
    if (/(office|location|address|where|visit)/.test(t))
      return "We have 2 offices in Ghaziabad: (1) Ansal Tanushree, Near Mahagunpuram, Mehrauli, NH24. (2) Shop UG15, Esquire Market, Ruchira Sapphire, Jaipuria Sunrise Greens, NH24. You're welcome to visit! 📍 Or reach us on 9911312139 / 9711191198.";
    if (/(safe|secure|trust|legit|genuine|legal)/.test(t))
      return "100% genuine and safe! 🛡️ We have 2 visitable offices in Ghaziabad, 150+ happy clients, and ₹50 Crore+ handled. Card details are never stored. Reach us on 9911312139 / 9711191198.";
    ...
    return "Thanks for your message! For a quick, accurate answer please tap WhatsApp or Call below on 9911312139 / 9711191198 — our team will assist you right away. 🙏";
  }
